...
extension SQLInsertBuilder {
    ...
    /// ```
    @discardableResult
    public func psql_ignoringConflicts(withConstraint constraint: String) -> Self {
    ...
    public func psql_ignoringConflicts(withConstraint constraint: any SQLExpression) -> Self {
        self.insert.genericConflictStrategy = PostgreSQLConstraintConflictResolutionStrategy(constraint: constraint, action: .noAction)
        return self
    }
    ...
    ///     .psql_onConflict(withConstraint: "uq_users_email", do: .update([
    ...
    /// ```
    @discardableResult
    public func psql_onConflict(withConstraint constraint: String, `do` updatePredicate: (SQLConflictUpdateBuilder) throws -> SQLConflictUpdateBuilder) rethrows -> Self {
    ...
    /// ```
    @discardableResult
    public func psql_onConflict(withConstraint constraint: any SQLExpression, `do` updatePredicate: (SQLConflictUpdateBuilder) throws -> SQLConflictUpdateBuilder) rethrows -> Self {
        let conflictBuilder = SQLConflictUpdateBuilder()
        _ = try updatePredicate(conflictBuilder)
        self.insert.genericConflictStrategy = PostgreSQLConstraintConflictResolutionStrategy(
