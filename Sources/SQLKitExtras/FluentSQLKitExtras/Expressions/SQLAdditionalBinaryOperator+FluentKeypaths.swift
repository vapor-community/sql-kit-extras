...
extension SQLExpression {
    ...
    /// to different models,  and a ``SQLAdditionalBinaryOperator``.
    ...
    /// value as the right-hand operand, and a ``SQLAdditionalBinaryOperator`` as the operator.
    public static func expr(
...
extension SQLPredicateBuilder {
    ...
    /// a ``SQLAdditionalBinaryOperator`` as the operator.
    @discardableResult
    public func `where`(
        _ keypath: KeyPath<some Schema, some QueryAddressableProperty>,
        _ op: SQLAdditionalBinaryOperator,
    ...
    /// to different models, as the operands and a ``SQLAdditionalBinaryOperator`` as the operator.
    @discardableResult
    public func `where`(
    ...
    /// left-hand operand and a ``SQLAdditionalBinaryOperator`` as the operator.
    @discardableResult
    public func orWhere(
        _ keypath: KeyPath<some Schema, some QueryAddressableProperty>,
        _ op: SQLAdditionalBinaryOperator,
    ...
    /// optionally refer to different models, as the operands and a ``SQLAdditionalBinaryOperator`` as the operator.
    @discardableResult
    public func orWhere(
        _ keypath1: KeyPath<some Schema, some QueryAddressableProperty>,
        _ op: SQLAdditionalBinaryOperator,
...
extension SQLSecondaryPredicateBuilder {
    ...
    /// and a ``SQLAdditionalBinaryOperator`` as the operator.
    @discardableResult
    public func having(
        _ keypath: KeyPath<some Schema, some QueryAddressableProperty>,
        _ op: SQLAdditionalBinaryOperator,
    ...
    /// refer to different models, as the operands, and a ``SQLAdditionalBinaryOperator`` as the operator.
    @discardableResult
    public func having(
        _ keypath1: KeyPath<some Schema, some QueryAddressableProperty>,
        _ op: SQLAdditionalBinaryOperator,
